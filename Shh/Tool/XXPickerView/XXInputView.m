...
- (void)initPropertyDefaultValue {
    ...
    _attributesTitle = @{NSFontAttributeName : [UIFont systemFontOfSize:15.0f],
                            NSForegroundColorAttributeName : DSColorFromHex(0x969696)};
    
    _hideSeparator = NO;
    
    _separatorColor = DSColorFromHex(0x969696);
}
...
- (void)addTitleBarView {
    ...
    NSAttributedString *okTitleAttStr = [[NSAttributedString alloc] initWithString:@"确定" attributes:@{NSFontAttributeName : [UIFont systemFontOfSize:15.0f],
...
- (void)addSeparatorView {
    ...
    UIView *separatorView = [[UIView alloc] initWithFrame:CGRectMake(0, kTopViewHeight + 1, ScreenWidth, 0)];
