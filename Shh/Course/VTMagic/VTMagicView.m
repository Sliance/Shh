...
- (void)graduallyChangeColor {
    ...
    UIColor *nextColor = RGBCOLOR(69, 69, 69);
    UIColor *selectedColor =DSColorFromHex(0xE70019);
...
- (UIView *)sliderView {
    if (!_sliderView) {
        ...
        _sliderView.backgroundColor = RGBACOLOR(255, 76, 77, 1);
    }
    return _sliderView;
}
...
//    self.sliderView.backgroundColor = _sliderColor ?: [UIColor whiteColor];
    self.sliderView.backgroundColor = DSColorFromHex(0xE70019);
