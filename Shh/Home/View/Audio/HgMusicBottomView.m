...
-(instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _songSlider.tintColor = DEFAULTColor;
        _songSlider.minimumTrackTintColor = DEFAULTColor;
        ...
        [_currentTimeLabel setTextColor:[UIColor lightGrayColor]];
        ...
        [_durationTimeLabel setTextColor:[UIColor lightGrayColor]];
