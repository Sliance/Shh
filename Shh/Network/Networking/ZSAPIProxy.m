...
- (void)showLoading {
    ...
    if ([viewController isKindOfClass:[ShhTabBarController class]]) {
        ShhTabBarController *tabbar = (ShhTabBarController *)viewController;
...
- (void)hiddenLoading {
    ...
    if ([controller isKindOfClass:[ShhTabBarController class]]) {
        ShhTabBarController *tabbar = (ShhTabBarController *)controller;
        if ([tabbar.selectedViewController isKindOfClass:[UINavigationController class]]) {
            UINavigationController *nav = (UINavigationController *)tabbar.selectedViewController;
            [self.arrayLodingControllers addObjectsFromArray:nav.viewControllers];
            dispatch_async(dispatch_get_main_queue(), ^{
